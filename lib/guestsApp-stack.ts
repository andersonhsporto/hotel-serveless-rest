...
export class GuestsAppStack extends cdk.Stack {
   ...
   constructor(scope: Construct, id: string, props?: cdk.StackProps) {
      ...
      const guestsLayer = lambda.LayerVersion.fromLayerVersionArn(this, "GuestsLayerVersionArn", guestsLayerArn)
      
      this.guestsFetchHandler = new lambdaNodeJS.NodejsFunction(this, 
         "GuestsFetchFunction", {
      ...
      this.guestsAdminHandler = new lambdaNodeJS.NodejsFunction(this, 
         "GuestsAdminFunction", {
